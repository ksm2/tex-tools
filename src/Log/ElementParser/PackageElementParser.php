 ...
 * @author moellers
 */
class PackageElementParser implements ElementParserInterface
{
    ...
    public function parse(LogElement $element)
    {
        ...
        foreach ($matches as $match) {
            list(, $package, $level, $content) = $match;
            ...
            $messages[] = new Message('Package ' . $package, $this->mapPackageLevel($level), $element->getFilename(), $line, $content);
        }
